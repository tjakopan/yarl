 ...
 * The captured result of executing a policy.
 */
sealed class PolicyResultGeneric<out TResult>(val context: Context) {
  fun <T> fold(
   ...
   */
  class Success<out TResult>(val result: TResult?, context: Context) : PolicyResultGeneric<TResult>(context)
  ...
  sealed class Failure<out TResult>(val faultType: FaultType, context: Context) :
    PolicyResultGeneric<TResult>(context) {
    /**
